...
<head>
    ...
    <?php Session::init(); /*var_dump($_SESSION); exit;*/ ?>
...
<body>
    ...
    <header class="header">
        <div class="header__container">
            <a href="#" class="header__logo">Estrutura MVC - VUE by Lucas Raineri</a>

            <a href="#" class="header__logo"><?php if (isset($_SESSION['nome'])){
                echo($_SESSION['nome']);
            } ?></a>
                    ...
                    <div class="nav__items">
                        ...
                        <div class="nav__dropdown">
                            <a href="#" class="nav__link">
                                ...
                                <span class="nav__name">Barra De Navegação</span>
                            ...
                            <div class="nav__dropdown-collapse">
                                <div class="nav__dropdown-content">
                                    ...
                                    <?php  if (isset($_SESSION['logado'])) { if ($_SESSION['nivel'] == 1 || $_SESSION['nivel'] == 2 ) { ?>
                                        <a href="<?= URL ?>tipo_lancamento" class="nav__dropdown-item">Tipo de Lançamentos</a>
                                        <a href="<?= URL ?>relatorio" class="nav__dropdown-item">Relatórios</a>
                                    <?php } } ?>
                                    <?php if (isset ($_SESSION['logado'])) { if ($_SESSION['nivel'] == 1) { ?>
                                        <a href="<?= URL ?>cadastro_usuario" class="nav__dropdown-item">Cadastro de novos Usuarios</a>
                                    <?php } } ?>
                                </div>
                            </div>
                        </div>
...
<!--                        </a>-->
<!---->
<!--                        <a href="--><?php //= URL ?><!--files" class="nav__link">-->
<!--                            <i class='bx bx-upload nav__icon'></i>-->
<!--                            <span class="nav__name">Arquivos</span>-->
<!--                        </a>-->
<!---->
<!--                        <a href="--><?php //= URL ?><!--coloracao" class="nav__link">-->
...
<!--                            <div class="nav__dropdown-collapse">-->
<!--                                <div class="nav__dropdown-content">-->
<!--                                    <a href="--><?php //= URL ?><!--nodificacao" class="nav__dropdown-item">Aparecer Nodificação</a>-->
<!--                                </div>-->
<!--                            </div>-->
<!---->
<!--                        </div>-->
<!---->
<!--                        <a href="--><?php //= URL ?><!--map" class="nav__link">-->
<!--                            <i class='bx bx-compass nav__icon'></i>-->
<!--                            <span class="nav__name">Explorar</span>-->
<!--                        </a>-->
<!--                        <a href="--><?php //= URL ?><!--login" class="nav__link">-->
<!--                            <i class='bx bx-bookmark nav__icon'></i>-->
<!--                            <span href="--><?php //= URL ?><!--login" class="nav__link"> class="nav__name">Sair</span>-->
<!--                        </a>-->
                    </div>
                </div>
            </div>
